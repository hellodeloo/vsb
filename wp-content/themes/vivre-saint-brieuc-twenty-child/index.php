...
<html lang="fr">
	...
	<body>
		...
		<footer>
			<h3>Retrouvez-nous sur les réseaux sociaux ou via notre formulaire de contact</h3>
			<ul>
				<li>
					<a href="https://www.instagram.com/vivre_saint_brieuc" target="_blank">
						<span class="visually-hidden">Retrouvez-nous sur Instagram</span>
						<i class="ri-instagram-line" aria-hidden="true"></i>
					</a>
				</li>
				<li>
					<a href="https://www.facebook.com/people/Vivre-Saint-Brieuc/61551022785564/" target="_blank">
						<span class="visually-hidden">Retrouvez-nous sur Facebook</span>
						<i class="ri-facebook-circle-line" aria-hidden="true"></i>
					</a>
				</li>
				<li>
					<a href="https://forms.sbc37.com/6916c6700be67270a92407bb/lTmDjbYZTIyc4Lsd93F6Bg/form.html" target="_blank">
